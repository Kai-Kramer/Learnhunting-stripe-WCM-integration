...
export default function Avatar(props) {
	const { avatarDetails, getInitialValues } = props;
	...
	return (
		<>
			<button
				className="mb-6 flex cursor-pointer items-center gap-2 rounded-full bg-transparent p-0 font-normal normal-case text-foreground hover:bg-transparent hover:text-foreground"
